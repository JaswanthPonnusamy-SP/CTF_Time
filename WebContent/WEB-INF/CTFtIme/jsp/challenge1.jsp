...
if(count!=0){
	if(username.equals("http://localhost:8012/CTFtIme/adminwifipage")){
...
<input type="text" name="passcode" id="passcode" placeholder="wifi passcode.." maxlength="8" style="width: 300px;height: 30px;font-size: 18px;border-color: #212529;border-style: solid;opacity: 0.5;font-family: sans-serif;">
