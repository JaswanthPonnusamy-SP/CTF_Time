...
<input type="text" name="username" maxlength="8" style="width: 21%;height: 5%;margin-left: 37.5%;position: absolute;margin-top: 8%;font-size: 150%;border-color: #212529;border-style: solid;opacity: 0.4">
